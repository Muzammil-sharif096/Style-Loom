            ...
            <div className='border-[#81807E] border-2 py-4 border-dashed relative overflow-hidden rounded-md'>
                <div className='flex'>
                    <div className='p-4 xl:p-14 space-y-4'>
                        ...
                        <ul className='flex sm:gap-4 gap-1 text-white tracking-wider text-center items-center'>
                            <li className='sm:w-24 px-3  p-1 sm:text-base text-sm border-[#81807E] border-2 border-dashed  rounded-md '>All</li>
                            <li className='sm:w-24 px-3  p-1 sm:text-base text-sm border-[#81807E] border-2 border-dashed  rounded-md '>Mens</li>
                            <li className='sm:w-24 px-3  p-1 sm:text-base text-sm border-[#81807E] border-2 border-dashed  rounded-md '>Womens</li>
                            <li className='sm:w-24 px-3  p-1 sm:text-base text-sm border-[#81807E] border-2 border-dashed  rounded-md '>Kids</li>
                        </ul>
                    </div>
                ...
                <div className='p-4 xl:p-14 border-[#81807E] border-2 tracking-wide border-dashed'>
                    <div className='flex  justify-between items-center'>
                        ...
                        <button className=' rounded-lg xl:w-40 w-24 xl:h-12 h-8 border-[#81807E] border-2 border-dashed text-white text-base tracking-widest bg-[#1A1A1A]'>View All</button>
                    </div>
                </div>
                            ...
                            return (
                                <div className='border-[#81807E] border-2 tracking-wide border-dashed p-4 xl:p-14 space-y-6' >
                                    ...
                                    <div className='flex  items-center justify-between'>
                                        ...
                                        <button className=' rounded-lg xl:w-40 w-28  xl:h-12 h-8 border-[#81807E] border-2 border-dashed text-white text-base tracking-widest bg-[#1A1A1A]'>Shop Now</button>
                                    </div>
